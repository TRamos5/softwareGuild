...
function luckySeven(){
    ...
    if(initialBet <= 0){
        alert('You need more money iny our bet')
    }
    else{
    ...
    document.getElementById('table').innerHTML=(
        "<center><br><br><table style=\"width: 100% height: 100%; color: white;\"><tr><th class=\"th2\">Starting Bet</th><th class=\"th2\">$" + initialBet + ".00</th></tr><tr><td>Total Rolls Before Going Broke</td><td>"+ rolls +"</td></tr><tr><td>Highes Amount Won</td><td>$"+totalMax+".00</td></tr><tr><td>Roll Count at Highest Amount Held</td><td> "+ numRolls + "</td></tr></table></center>");
